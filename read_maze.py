...
# load maze
def load_maze():
    if not os.path.exists("H:\DLwork\\\COMP6247CW-20212022SupportingFiles\\COMP6247Maze20212022.npy"):
        raise ValueError("Cannot find %s" % file_path)

    else:
        global maze_cells
        maze = np.load("H:\DLwork\\\COMP6247CW-20212022SupportingFiles\\COMP6247Maze20212022.npy", allow_pickle=False, fix_imports=True)
